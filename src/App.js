                        ...
                        */}
                        ...
                        {!showFacilitiesMenu &&( // showFacilitiesMenu 상태에 따라 보이게 설정
                            <div className='showingFacilitiesBtns'>
                                ...
                                {ToggBtnType!=='sports' && (<div className='showingFacBtnT'><button className='showingFacBtn' onClick={() => setToggBtnType('sports')}><img src={Icons.basketballIcon} alt="Basketball Icon" className="iconImage" /></button>▽운동시설</div>)}
                                {ToggBtnType=='sports' &&(
                                    <div>
                                ...
                                {ToggBtnType!=='dining' && (<div className='showingFacBtnT'><button className='showingFacBtn' onClick={() => setToggBtnType('dining')}><img src={Icons.cafeteriaIcon} alt="Cafeteria Icon" className="iconImage" /></button>▽식당</div>)}
                                {ToggBtnType=='dining' && (
                                    <div>
                                        ...
                                        <div className='showingFacBtnT'><button className='showingFacBtn' onClick={() => handleShowReq('cafeteria')}><img src={Icons.cafeteriaIcon} alt="Cafeteria Icon" className="iconImage" /></button>식당</div>
                                    </div>
                                )}
                                {ToggBtnType!=='cafe&store' && (<div className='showingFacBtnT'><button className='showingFacBtn' onClick={() => setToggBtnType('cafe&store')}><img src={Icons.cafeteriaIcon} alt="Cafeteria Icon" className="iconImage" /></button>▽카페/편의점</div>)}
                                ...
                                <div className='showingFacBtnT'><button className='showingFacBtn' onClick={() => handleShowReq('print')}><img src={Icons.printIcon} alt="Print Icon" className="iconImage" /></button>무인민원발급기</div>
                                ...
                                <div className='showingFacBtnT'><button className='showingFacBtn' onClick={() => handleShowReq('bench')}><img src={Icons.benchIcon} alt="Bench Icon" className="iconImage" /></button>옥상정원</div>
                                ...
                                <div className='showingFacBtnT'><button className='showingFacBtn' onClick={() => handleShowReq('breakroom')}><img src={Icons.breakRoomIcon} alt="Break Room Icon" className="iconImage" /></button>샤워실</div>
