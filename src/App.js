                        ...
                        */}
                        ...
                        {BarrierFreeMode && (
                            <div style={{borderStyle: 'solid', borderColor: '#FFCD4A', margin: '0 0 5px 7px'}}>
                                <div style={{fontSize: '15px', fontWeight: 'bold', textAlign: 'center',margin: '5px 0 5px 0', fontFamily: 'Pretendard-Regular'}}>캠퍼스 내 장애물 위치 보기</div>
                        ...
                        <div style={{borderStyle: 'solid', borderColor: '#FFCD4A', margin: '0 0 5px 7px'}}>
                        <div style={{fontSize: '15px', textAlign: 'center', marginTop: '5px', marginBottom: '0px', display: 'flex', flexDirection: 'column',alignItems: 'center', fontFamily: 'Pretendard-Regular', fontWeight: 'bold'}}>편의시설 둘러보기</div>
                        ...
                        <div className="pathfinder-page">
                            {BarrierFreeMode && (
                                <div style={{borderStyle: 'solid', borderColor: '#FFCD4A', margin:'0 0 5px 10px'}}>
                                    <div style={{fontSize: '15px', fontWeight: 'bold', textAlign: 'center',margin: '5px 0 5px 0', fontFamily: 'Pretendard-Regular'}}>길찾기 경로 옵션</div>
