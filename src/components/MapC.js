...
export const MapC = ({ pathData, width, height, keyword, setKeyword, bol, bump, slopeD, showObs, category, onObstacleAvoidance, setStairExist, setunpavedExist, setslopeExist, setinExist }) => {
    const map = useMap();
